...
import { createCreatorAccount } from "@/utils/interact";
interface IParam {
  show: boolean
  onHide: () => void
}
  ...
  const CreatorAccount = async () => {
    try{
      ...
      if(window.ethereum && window.ethereum.isMiniPay){
        await createCreatorAccount(removeSpace(username), hash, bio, phone, "celo", account as string )
      }
          ...
          <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
            ...
            <div className="modal-body relative p-4">
              <div className="flex justify-center flex flex-col">
                ...
                <FormInput placeholder="Enter phone number" value={ phone } type="text" onChange={ phoneHandler } />
